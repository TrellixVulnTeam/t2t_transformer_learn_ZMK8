...
_AC_TRAIN_DATASETS = [[
    _STAT_MT_URL + "train.tgz", [
        "20180827.en", "20180827.zh"
    ]
]]
...
_AC_TEST_DATASETS = [[
    ...
    ("ai_challenger_MTEnglishtoChinese_validationset_20180823_en.sgm",
    "ai_challenger_MTEnglishtoChinese_validationset_20180823_zh.sgm")
]]
...
@registry.register_problem
class TranslateEnzhAc8k(TranslateEnzhAc32k):
  """Problem spec for WMT En-Zh translation.
